...
void TestVector()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        VECTOR_INSERT_SUM += 1000.00 * (end - begin) / CLOCKS_PER_SEC;
    }
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        VECTOR_REMOVE_SUM += 1000.00 * (end - begin) / CLOCKS_PER_SEC;
    }
...
void TestVectorPtr()
{
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        VECTOR_POINTER_INSERT_SUM += 1000.00 * (end - begin) / CLOCKS_PER_SEC;
    }
    ...
    for (int i = 0; i < 10; i++)
    {
        ...
        VECTOR_POINTER_REMOVE_SUM += 1000.00 * (end - begin) / CLOCKS_PER_SEC;
    }
